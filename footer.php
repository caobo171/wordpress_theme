<div class="row footer">
    ...
    <div class="col footer-col  col-md-3 col-12">
        ...
        <p class="col-description"> 0985 082 545 - 0985 082 545</p>
        <p class="col-description"> luongy.congduc2016@gmail.com</p>
    ...
    <div class="col footer-col  col-md-2 col-12">
        ...
        <p class="col-description">CHÍNH SÁCH BẢO HÀNH VÀ ĐỔI TRẢ</p>
    ...
    <div class="col footer-form col-md-4 col-12">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control col-input" placeholder="Nhập họ và tên ...">
            </div>
            <div class="form-group">
                <label class="col-label">Email</label>
                <input type="text" class="form-control col-input" placeholder="Nhập email...">
            </div>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label class="col-label">Điện thoại</label>
                    <input type="text" class="form-control col-input" placeholder="Nhập số điện thoại ...">
                </div>
            </div>
            <div class="form-row">
                <textarea class="form-control col-input" placeholder="Nhập nội dung ..."></textarea>
            </div>
            <button type="submit" class="btn footer-form-btn">Gửi</button>
        </form>
